	...
	class thc_post_manager {
		static function save($post_id) {
		   ...
		   $dDiff = $dStart->diff($dEnd);
				...
				$_SESSION['thc_metabox_success'] = __( 'Event saved successfully!', 'the-holiday-calendar' );
				$_SESSION['thc_metabox_errors'] = '';
			}
			else
			{
				$_SESSION['thc_metabox_errors'] = __( 'Wrong input! Please try again or your event will not be visible.', 'the-holiday-calendar' );
			}
		}

		static function convert_date_to_generic_date_format($date)
		{
