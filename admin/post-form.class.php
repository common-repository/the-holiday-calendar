	...
	class thc_post_form {
		public static function render_meta_box_content( $post ) {
			...
			?>
				<table>
					<tr>
						<td><?php _e( 'Start date (input: mm/dd/yyyy):', 'the-holiday-calendar' ); ?></td>
						<td>
							<input type="text" name="EventDate" id="EventDate" value="<?php echo $eventDate; ?>" /></td>
							<td><?php _e( 'Start time (input: hh:mm) (optional):', 'the-holiday-calendar' ); ?></td>
							<td>
								<input type="text" name="EventTime" id="EventTime" value="<?php echo $eventTime; ?>" /></td>
					</tr>
					<tr>
						<td><?php _e( 'End date (input: mm/dd/yyyy):', 'the-holiday-calendar' ); ?></td>
						<td>
							<input type="text" name="EventDateEnd" id="EventDateEnd" value="<?php echo $eventDateEnd; ?>" /></td>
								<td><?php _e( 'End time (input: hh:mm) (optional):', 'the-holiday-calendar' ); ?></td>
								<td>
